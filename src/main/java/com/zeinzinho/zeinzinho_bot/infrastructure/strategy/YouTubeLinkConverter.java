...
/**
 * Strategy for converting YouTube links to enhanced format for better embeds in
 * Discord.
 * Currently returns the original URL as YouTube embeds work well natively in
 * Discord.
...
public class YouTubeLinkConverter implements LinkConverterStrategy {
  ...
  public ConvertedLink convert(String originalUrl) {
    ...
    // This could be enhanced in the future with timestamp extraction or other
    // features
